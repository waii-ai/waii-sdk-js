...
const GET_CATALOG_ENDPOINT = 'get-table-definitions';
const UPDATE_TABLE_DESCRIPTION_ENDPOINT = 'update-table-description';
const UPDATE_SCHEMA_DESCRIPTION_ENDPOINT = 'update-schema-description';
const UPDATE_COLUMN_DESCRIPTION_ENDPOINT = 'update-column-description';
...
const UPDATE_CONSTRAINT_ENDPOINT = 'update-constraint';
...
class Database {
    ...
    public async modifyConnections(
        ...
        return this.httpClient.commonFetch<ModifyDBConnectionResponse>(MODIFY_DB_ENDPOINT, params, signal);
    }
    ...
    public async getConnections(
        ...
        return this.httpClient.commonFetch<GetDBConnectionResponse>(MODIFY_DB_ENDPOINT, params, signal);
    }

    public async activateConnection(key: string, signal?: AbortSignal): Promise<GetDBConnectionResponse> {
    ...
    public async getCatalogs(params: GetCatalogRequest = {}, signal?: AbortSignal): Promise<GetCatalogResponse> {
        return this.httpClient.commonFetch<GetCatalogResponse>(GET_CATALOG_ENDPOINT, params, signal);
    }
    ...
    public async extractDatabaseDocumentation(
        ...
        signal?: AbortSignal
    ): Promise<ExtractDatabaseDocumentationResponse> {
    ...
    public async checkSimilaritySearchIndexStatus(
        ...
        signal?: AbortSignal
    ): Promise<CheckOperationStatusResponse> {
    ...
    public async updateSimilaritySearchIndex(
        ...
        signal?: AbortSignal
    ): Promise<UpdateSimilaritySearchIndexResponse> {
    ...
    public async getSimilaritySearchIndex(
        ...
        signal?: AbortSignal
    ): Promise<GetSimilaritySearchIndexResponse> {
    ...
    public async getSimilaritySearchIndexOnTable(
        ...
        signal?: AbortSignal
    ): Promise<GetSimilaritySearchIndexOnTableResponse> {
    ...
    public async deleteSimilaritySearchIndex(
        ...
        signal?: AbortSignal
    ): Promise<DeleteSimilaritySearchIndexResponse> {
    ...
    public async updateConstraint(
        ...
        return this.httpClient.commonFetch<UpdateConstraintResponse>(UPDATE_CONSTRAINT_ENDPOINT, params, signal);
    }
}
